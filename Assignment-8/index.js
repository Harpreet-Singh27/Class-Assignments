...
app.post('/formpage', (req, res) => {
  ...
  const message = {
    to: email,
    from: 'harpreet0414.cse19@chitkara.edu.in',
    subject: 'Creted By Harpreet Singh',
...
const DB =
  'mongodb+srv://happy:happy123@aseight.kzegg.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';
